...
[CAV: Bego, this needs to be updated to use the new data splits, plotting for 
each fold. This is probably not needed as you have plots in a later chunk.]
...
[CAV: Bego, I cannot run this as I don't have access to the `survival_curves` 
object. Please edit earlier code according to my suggestions. Maybe this is not needed as you are doing plots later on in the bootstrap section?]
...
[CAV: we need to update to explain how the results are summarised. The code
below seems to have some legacy code that is not used anymore. I think that 
the up-to-date code is from line 731 onwards, correct?]
