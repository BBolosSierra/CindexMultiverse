...
#use_condaenv("/opt/conda/envs/py-rstudio/bin/python", required=TRUE)
...
use_condaenv("py-rstudio", required = TRUE)  # Uses env name, not full path
py_config()  
...
```{r Plot fig.width=8, fig.height=11}
# Plot
...
```{r Format plot 2,  fig.width=8, fig.height=11}
# Add notation
surv_df_plot$Notation           <- "C_td"
...
surv_df_plot$Incl.Ties.Preds <- ifelse(surv_df_plot$Metric == "pycox.Adj.Ant", 
                                          "pycox*", "pycox")
rmst_df_plot_incl_ties$Incl.Ties.Preds <- ifelse(
  rmst_df_plot_incl_ties$Metric == "pec::cindex", "pec*",
  ifelse(rmst_df_plot_incl_ties$Metric == "Hmisc::rcorr.cens", "Hmisc*",
         paste0(rmst_df_plot_incl_ties$Metric, "*"))
)
rmst_df_plot_excl_ties$Incl.Ties.Preds <- ifelse(
  rmst_df_plot_excl_ties$Metric == "pec::cindex", "pec",
  ifelse(rmst_df_plot_excl_ties$Metric == "Hmisc::rcorr.cens", "Hmisc",
         rmst_df_plot_excl_ties$Metric)
)
